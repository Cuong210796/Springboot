...
public interface PersonRepositoryInterface {
  ...
  List<Person> sortPeopleByFullNameSorted(); //Liệt kê danh sách sắp xếp theo tên full name từ Z-A
  ...
  */
  ...
  HashMap<String, Integer> groupCityByCount();

  List<Map.Entry<String, Integer>> findTop5Jobs(); //Tìm 5 nghề có số lượng người làm nhiều nhất sắp xếp từ cao xuống thấp

  List<Map.Entry<String, Integer>> findTop5Citis(); //Tìm 5 thành phố có số người thuộc danh sách sinh sống đông nhất từ vị trí thứ 5 đến vị trí thứ 1

  List<Map.Entry<String, HashMap<String, Integer>>> findTopJobInCity(); //Ở mỗi thành phố, tìm nghề nào có nhiều người làm nhất
